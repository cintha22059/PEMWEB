...
<head>
    ...
    <style>
        ...
        .modal {
            ...
            height: 100%;
            overflow: auto;
            /* Menambahkan overflow:auto agar modal dapat di-scroll */
        ...
        .modal-img {
            max-width: 100%;
            /* Menyesuaikan lebar gambar dengan lebar modal */
            height: auto;
...
<body>
        ...
        <div class="card news-item">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Pada tanggal 1 Maret 2024, Layanan Pengaduan Online kami mengalami perubahan besar.
                    ...
                    lebih cepat dan responsif dalam menangani masalah mereka.</p>
        ...
        <div class="card news-item" id="news3">
            ...
            <p class="text-sm-start">01-25-2024 01:00:00</p>
                <p class="card-text">Kami ingin menginformasikan bahwa Layanan Pengaduan Online kami telah tersedia
                    ...
                    dan akan memberikan respon secepat mungkin.</p>
    ...
    <div id="modal1" class="modal">
        <div class="modal-content">
            ...
            <p class="card-text">Pada tanggal 1 Maret 2024, Layanan Pengaduan Online kami mengalami perubahan besar.
                Kami telah memperbarui antarmuka pengguna untuk meningkatkan kemudahan penggunaan dan meningkatkan
                efisiensi dalam penanganan pengaduan. Dengan perubahan ini, pengguna akan mengalami proses yang lebih
                cepat dan responsif dalam menangani masalah mereka.</p>
        </div>
    </div>
    ...
    <div id="modal2" class="modal">
        <div class="modal-content">
            ...
            <p class="card-text">Kami telah menambahkan beberapa fitur baru di Layanan Pengaduan Online kami. Kami
                senang mengumumkan bahwa Layanan Pengaduan Online kami telah melakukan pembaruan besar. Kami telah
                memperbaiki beberapa bug dan menambahkan beberapa fitur baru yang akan mempermudah penggunaan layanan
                ini.</p>
        </div>
    </div>
    ...
    <div id="modal3" class="modal">
        <div class="modal-content">
            ...
            <p class="card-text">Kami ingin menginformasikan bahwa Layanan Pengaduan Online kami telah tersedia untuk
                ...
                yang dialami. Kami akan melakukan tindak lanjut terhadap setiap pengaduan yang masuk dan akan memberikan
                respon secepat mungkin.</p>
        </div>
    </div>
